...
# Economical factors except for Total expenditure affect life expectancy. While population does not affect life expectancy at all.
...
ggplot(data = mortality_health, aes(x = `Total expenditure`, y = `Life expectancy`, color = Status)) + geom_point()

ggplot(data = mortality_health, aes(x = `Total expenditure`, y = `Adult Mortality`, color = Status)) + geom_point() 
