...
abline(h = 0)
hist(economy_residual) #skewed to the right
```
...
ggplot(data = life_expectancy, aes(x = Year, y = `Life expectancy`)) + geom_point() + geom_line()
...
summary(ph_lm)
backward_ph <- step(ph_lm, direction = "backward", scope = formula(ph_lm))
backward_ph
```
